...
- **Phase**: P9a ([plans/04-phases.md#p9-conformance-test--loki-retirement](../plans/04-phases.md))
- **Status**: Open
...
- [ ] **逸脱の最新化**: §10.5 `linear_graphql` は mcpproxy ではなく **codex native `item/tool/call`**、かつ advertise は pinned codex 0.128.0 で blocked（[024](024-p8b-linear-graphql-tool.md) §B）である旨を posture として明記
