...
// real ~/.agent-grid/settings.toml (which may select devcontainer mode and shell out
// to docker) nor writes the real ~/.agent-grid/server.log. Both logger.Init and the
