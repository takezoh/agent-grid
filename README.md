...
- **`arc`** — the tmux control surface (interactive TUI for managing agent sessions) — the `client` layer
...
```bash
arc                   # create/attach a tmux session with a 3-pane layout
