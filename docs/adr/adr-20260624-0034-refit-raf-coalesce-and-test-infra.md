...
Related: [spec](../specs/2026-06-24-web-ui-fixes/spec.md), [plan](../specs/2026-06-24-web-ui-fixes/plan.md), [ADR 0029](../adr/adr-20260624-0029-terminal-host-flex-height.md)
...
本 ADR は CSS による高さ確定 ([ADR 0029](../adr/adr-20260624-0029-terminal-host-flex-height.md)) の **従属対策** であり、CSS 修正と併せて初めて FR-008 (0 サイズ回避) が成立する。
...
- `scheduleFit` は flex 高さ確定 ([ADR 0029](../adr/adr-20260624-0029-terminal-host-flex-height.md)) が前提で、CSS 修正と併せて初めて 0 サイズ回避が成立する
