---
id: adr-20260624-0034-refit-raf-coalesce-and-test-infra
kind: adr
title: ADR 0034 — Refit を rAF コアレスへ集約し happy-dom 用テスト基盤を整備 (Web UI 問題4)
status: accepted
created: '2026-06-24'
updated: '2026-07-04'
tags:
...
Related: [spec](../changes/change-20260624-2026-06-24-web-ui-fixes/requirements.md), [plan](../changes/change-20260624-2026-06-24-web-ui-fixes/implementation.md), [ADR 0029](adr-20260624-0029-terminal-host-flex-height.md)
...
本 ADR は CSS による高さ確定 ([ADR 0029](adr-20260624-0029-terminal-host-flex-height.md)) の **従属対策** であり、CSS 修正と併せて初めて FR-008 (0 サイズ回避) が成立する。
...
- `scheduleFit` は flex 高さ確定 ([ADR 0029](adr-20260624-0029-terminal-host-flex-height.md)) が前提で、CSS 修正と併せて初めて 0 サイズ回避が成立する
