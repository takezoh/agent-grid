...
Empirical constraints established while diagnosing the "Idle-stuck-badge" bug (2026-07-01, see [ADR-0001](0001-multiplexed-backends-shared-routing-contract.md) Update — passive adopt):
...
Related: [ADR-0001](0001-multiplexed-backends-shared-routing-contract.md) (Routing Isolation Invariant), [ADR-0002](0002-optin-appserver-e2e-validates-fakes.md) (fake fidelity backstop).
