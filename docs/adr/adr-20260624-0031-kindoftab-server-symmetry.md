---
id: adr-20260624-0031-kindoftab-server-symmetry
kind: adr
title: ADR 0031 — `kindOfTab` を server `matchLogTab` と対称な判定規則にする (Web UI 問題1・2)
status: accepted
created: '2026-06-24'
updated: '2026-07-04'
tags:
...
Status: Accepted (検出順は [ADR 0035](adr-20260624-0035-kindoftab-label-first-for-jsonl-transcripts.md) で path-first → label-first に反転)

Related: [spec](../changes/change-20260624-2026-06-24-web-ui-fixes/requirements.md), [plan](../changes/change-20260624-2026-06-24-web-ui-fixes/implementation.md), [ADR 0025](adr-20260624-0025-transcript-rest-backfill-then-ws-tail.md), [ADR 0035](adr-20260624-0035-kindoftab-label-first-for-jsonl-transcripts.md)
