...
Status: Superseded by [ADR 0077](./0077-mobile-touch-gesture-swipe-to-arrow.md) (pinch 経路は撤去。FontSizeControl ステッパー単独 path の persist / clamp 契約は ADR 0077 が継承)

Related: [ADR 0059](./0059-theme.md), [ADR 0068](./0068-mode-separation-focus-block-and-zoom-guard.md), [ADR 0072](./0072-coachmark-dismiss-and-once.md), [ADR 0077](./0077-mobile-touch-gesture-swipe-to-arrow.md)
...
- `FR-MOB-PERSIST-001` — FontSizeControl ステッパー確定時の localStorage 書込 + try/catch degrade (pinch 経路は ADR 0077 で撤去)
