---
id: adr-20260624-0042-palette-new-session-payload-wire-mirror
kind: adr
title: ADR 0042 — new-session 送信は host?:bool ではなく既存 wire (sandbox?:'host') に揃える
status: accepted
created: '2026-06-24'
updated: '2026-07-04'
tags:
...
本機能の host トグル ON は sandbox bypass を意味する。一方、既存 POST /api/sessions の apiCreateReq は sandbox?: 'auto' | 'host' という string enum を採用している。本 spec で host?:bool を新設すると wire 形式が二重化する。
...
- **positive**: wire vocabulary が単一に保たれる
