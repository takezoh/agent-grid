...
- {type: dependencyOf, target: task-20260707-codexclient-observability-log}
- {type: dependencyOf, target: task-20260707-handler-follow-backend}
- {type: dependencyOf, target: task-20260707-handler-follow-orchestrator}
- {type: dependencyOf, target: task-20260707-handler-follow-claude-app-server}
- {type: dependencyOf, target: task-20260707-fake-appserver-string-id}
- {type: dependencyOf, target: task-20260707-fakecodex-string-id}
- {type: dependencyOf, target: task-20260707-shim-2way-proxy}
- {type: dependencyOf, target: task-20260707-handler-follow-transcript}
source_paths:
