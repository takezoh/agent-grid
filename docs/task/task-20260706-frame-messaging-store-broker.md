...
- {type: dependencyOf, target: task-20260706-frame-messaging-web-surface}
- {type: dependencyOf, target: task-20260706-frame-messaging-phase1-tests}
- {type: dependencyOf, target: task-20260706-frame-messaging-mcp-tools}
source_paths:
- src/client/state/
- src/client/runtime/
