...
- **[Harness engineering assessment](../note/note-20260624-technical-harness-engineering-assessment.md)** — a dated evaluation of how well agent-reactor (the outer harness) drives Claude/Codex (the inner harness), graded across design, implementation, test, documentation, and CI, with prioritized recommendations.
