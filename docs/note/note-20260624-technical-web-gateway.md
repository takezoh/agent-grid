---
id: note-20260624-technical-web-gateway
kind: note
title: Web Gateway
status: published
created: '2026-06-24'
...
see [ADR 0012](../adr/adr-20260624-0012-daemon-client-eager-dial-supervisor.md)) against
...
event. See [ADR 0023](../adr/adr-20260624-0023-view-update-broadcast-shape.md) for the
1:1 mirror design.
...
[ADR 0025](../adr/adr-20260624-0025-transcript-rest-backfill-then-ws-tail.md).
...
policy in [ADR 0027](../adr/adr-20260624-0027-notification-toast-auto-dismiss-policy.md).
...
defined by [ADR 0011](../adr/adr-20260624-0011-two-step-ws-close-on-daemon-disconnect.md).
...
- [ADR 0006](../adr/adr-20260624-0006-surface-namespace-for-new-proto-commands.md) — unified
...
- [ADR 0011](../adr/adr-20260624-0011-two-step-ws-close-on-daemon-disconnect.md) — mandates
...
- [ADR 0012](../adr/adr-20260624-0012-daemon-client-eager-dial-supervisor.md) — specifies
...
- [ADR 0023](../adr/adr-20260624-0023-view-update-broadcast-shape.md) — defines the `"v"`
  frame as a 1:1 mirror of `proto.EvtSessionsChanged`; the `viewUpdateFrame`
  struct in `wire.go` implements this contract exactly.

- [ADR 0025](../adr/adr-20260624-0025-transcript-rest-backfill-then-ws-tail.md) — defines
...
- [ADR 0027](../adr/adr-20260624-0027-notification-toast-auto-dismiss-policy.md) — specifies
